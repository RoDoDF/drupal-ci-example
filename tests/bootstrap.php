...
function drupal_phpunit_contrib_extension_directory_roots($root = NULL) {
  ...
  $paths = [
    $root . '/htdocs/core/modules',
    $root . '/htdocs/core/profiles',
    $root . '/htdocs/modules',
    $root . '/htdocs/profiles',
    $root . '/htdocs/themes',
  ];
  $sites_path = $root .'/htdocs/sites';
...
function drupal_phpunit_populate_class_loader() {
  ...
  $loader = require __DIR__ . '/../htdocs/autoload.php';

  // Start with classes in known locations.
  $loader->add('Drupal\\Tests', './htdocs/core/tests');
  $loader->add('Drupal\\KernelTests', './htdocs/core/tests');
  $loader->add('Drupal\\FunctionalTests', './htdocs/core/tests');
  $loader->add('Drupal\\FunctionalJavascriptTests', './htdocs/core/tests');
